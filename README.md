[![Run App Alex Varvil](https://github.com/AVarvil/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/AVarvil/GithubActions/actions/workflows/run-app.yaml)
